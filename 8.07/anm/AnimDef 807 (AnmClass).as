package
{
    ...
    public class §_-d1W§
    {
        ...
        /*
        function: AddMove
        param1: String moveName
        param2: MovieClip srcMovie
        param3: uint startFrame
        param4: uint endFrame
        param5: uint loopFrame
        param6: uint recoverFrame
        param7: uint freeCriticalFrame
        param8: uint[] runEndFrames
        param9: String keyType
        param10: uint iconFrame
        */
