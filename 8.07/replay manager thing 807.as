    ...
    public class §_-L1T§
    {
        ...
        public static function §_-e4t§(param1:Array, param2:uint, param3:uint) : uint
        {
            ...
            while(_loc5_ < _loc6_)
            {
                ...
                if(_loc8_ != null)
                {
                    _loc4_ += uint(_loc8_.§_-z1A§ * 5);
                    _loc4_ += uint(_loc8_.§_-b2k§ * 93);
                    _loc4_ += uint(_loc8_.§_-d3q§ * 97);
                    _loc4_ += uint(_loc8_.§_-34n§ * 53);
                    _loc9_ = 0;
                    while(_loc9_ < int(8))
                    {
                        _loc10_ = _loc9_++;
                    ...
                    while(_loc9_ < _loc10_)
                    {
                        ...
                        _loc4_ += uint((_loc12_.§_-N3W§ & 65535) * (17 + _loc11_));
                ...
                if((_loc11_.§_-D1M§ & (§_-02x§.§_-R4L§ | §_-02x§.§_-I0§)) == 0)
                {
                    if(!(_loc4_ == ScoringType.BUDDY && (_loc11_ != null && §_-A1E§.§_-U3M§.§_-k33§(_loc11_.§_-Yl§))))
                    {
                        ...
                        while(_loc13_ < _loc14_)
                        {
                            ...
                            §_-D2i§.§_-05q§(_loc16_.§_-N3W§ & 65535);
        ...
        public function §_-nj§(param1:uint) : void
        {
            ...
            {
                _loc4_ = §_-A1E§;
                if((_loc4_.§_-r2A§ & (1024 | 2048 | 8192)) == 0)
                {
        ...
        public function §_-k5§() : void
        {
            ...
            {
                _loc3_ = §_-A1E§;
                if((_loc3_.§_-r2A§ & (1024 | 2048 | 8192)) == 0)
                {
